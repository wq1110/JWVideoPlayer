...
/**
 * Created by Joyce.wang on 2022/4/14.
 * M3U8文件中TS文件的结构
 */
public class M3U8Seg implements Comparable<M3U8Seg> {
    ...
    public String getInitSegProxyUrl(String md5, Map<String, String> headers) {
        ...
        //4.md5
        //5.init Seg存储的位置
        //6.init Seg url对应的请求headers
        String proxyExtraInfo = mSourceId + ProxyCacheUtils.SEG_PROXY_SPLIT_STR + mParentUrl + ProxyCacheUtils.SEG_PROXY_SPLIT_STR + mInitSegmentUri + ProxyCacheUtils.SEG_PROXY_SPLIT_STR +
    ...
    public String getSegProxyUrl(String md5, Map<String, String> headers) {
        ...
        //5.init Seg存储的位置
        //6.init Seg url对应的请求headers
        String proxyExtraInfo = mSourceId + ProxyCacheUtils.SEG_PROXY_SPLIT_STR + mParentUrl + ProxyCacheUtils.SEG_PROXY_SPLIT_STR + mUrl + ProxyCacheUtils.SEG_PROXY_SPLIT_STR +
