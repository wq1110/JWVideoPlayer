...
import com.media.jwvideoplayer.cache.okhttp.CustomTrustManager;
import com.media.jwvideoplayer.cache.task.Mp4VideoCacheThread;
...
public class HttpUtils {
    ...
    public static void trustAllCert(HttpsURLConnection httpsURLConnection) {
        ...
        try {
            ...
            logger.w("SSLContext init failed");
        }
