...
import com.media.jwvideoplayer.cache.m3u8.M3U8Utils;
...
import com.media.jwvideoplayer.cache.utils.VideoParamsUtils;
...
public class VideoInfoParseManager {
    private static Logger logger = LoggerFactory.getLogger(VideoInfoParseManager.class.getName());
            ...
            if (m3u8.isIsLive()) {
                ...
                VideoProxyThreadUtils.submitRunnableTask(() -> {
                    ...
                    try {
                        ...
                        logger.w("parseM3U8Info->createLocalM3U8File failed, exception=" + e);
                    }
                });
