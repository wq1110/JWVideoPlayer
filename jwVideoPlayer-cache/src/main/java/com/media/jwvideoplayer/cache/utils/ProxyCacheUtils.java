package com.media.jwvideoplayer.cache.utils;
...
import com.media.jwvideoplayer.cache.common.VideoMime;
...
public class ProxyCacheUtils {
    private static Logger logger = LoggerFactory.getLogger(ProxyCacheUtils.class.getName());
    public static final String LOCAL_PROXY_HOST = "127.0.0.1";
    public static final String LOCAL_PROXY_URL = "http://" + LOCAL_PROXY_HOST;
    public static final String SEG_PROXY_SPLIT_STR = "&trailer_seg&";           //M3U8 分片文件分隔符
    public static final String VIDEO_PROXY_SPLIT_STR = "&trailer_video&";       //视频分隔符
    public static final String HEADER_SPLIT_STR = "&trailer_header&";           //请求头部分隔符
    public static final String UNKNOWN = "unknown";
    public static final String M3U8 = "m3u8";
    public static final String NON_M3U8 = "non_m3u8";
    public static final String INIT_SEGMENT_PREFIX = "init_seg_";
    public static final String SOURCE_KEY_STR = "#";                           //sourceKey和source组合成唯一id分隔符
    ...
    public static void close(Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                logger.w("ProxyCacheUtils close " + closeable + " failed, exception = " + e);
            }
        }
    }
    ...
    public static String getProxyUrl(String sourceId, String videoUrl, Map<String, String> headers, Map<String, Object> cacheParams) {
        String videoInfo = getVideoTypeInfo(videoUrl, cacheParams);
        String headerStr = map2Str(headers);
        String proxyExtraInfo = sourceId + VIDEO_PROXY_SPLIT_STR  + videoUrl + VIDEO_PROXY_SPLIT_STR + videoInfo + VIDEO_PROXY_SPLIT_STR + headerStr;
    ...
    public static String getSourceId(String sourceKey, String source) {
        return sourceKey + SOURCE_KEY_STR + source;
    }
