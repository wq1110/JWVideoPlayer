...
public class VideoProxyThreadUtils {
    private static Logger logger = LoggerFactory.getLogger(VideoProxyThreadUtils.class.getName());
    ...
    private static class MediaWorkerThread extends Thread {
        ...
        public void run() {
            ...
            logger.i("ProxyCacheThreadHandler execution time: " + (endTime - startTime));
        }
    }
