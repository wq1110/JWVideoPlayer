...
public class VideoCacheInfo implements Serializable {
    ...
    private TreeMap<Long, Long> mVideoSegMap;//视频分片的保存结构
    private String mSourceId;                       //资源唯一的id
    ...
    public VideoCacheInfo(String sourceId, String url) {
        mSourceId = sourceId;
        mVideoUrl = url;
    }
    ...
    public void setVideoSegMap(TreeMap<Long, Long> videoSegMap) {
        mVideoSegMap = videoSegMap;
    }

    public TreeMap<Long, Long> getVideoSegMap() {
        return mVideoSegMap;
    }
